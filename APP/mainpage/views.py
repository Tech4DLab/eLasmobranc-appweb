...
from mainpage.modelo import model_cpu as model
...
# Build view context: model outputs + charts + optional Excel metadata and maps
    chart_data = {
        ...
        "valuesO": [0, 0, 0, 0],
        "familia": ["Pentanchidae","Scyliorhinidae", "Triakidae", "Oxynotidae", "Rajidae", "Torpedinidae"],
        "valuesF": [0, 0, 0, 0, 0, 0],
        "especie": [
            "Galeus melastomus",
            "Galeorhinus galeus",
    ...
    familia_map = ["pentanchidae","scyliorhinidae", "triakidae", "oxynotidae", "rajidae", "torpedinidae"]
    ...
    for result in model_results:
        ...
        if result[3] == "bocanegra":
            result[2] = "pentanchidae"
...
def generar_pdf(request):
    ...
    story.append(Paragraph("Resultados eLasmobranc", styles["Title"]))
